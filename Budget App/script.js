class Budget {
  ...
  editRow(selectedElement) {
    if (this.clickEdit == true) {
      ...
      this.description.value =
        selectedElement.querySelector("[data-description]").innerText;
      this.amount.value =
        selectedElement.querySelector("[data-amount]").innerText;
  ...
  showClearDataAlert() {
    ...
    setTimeout(
      () => this.clearAllDataDiv.removeChild(this.clearAllDataDiv.firstChild),
      10000
    );
  }
}
...
function eventListeners() {
  ...
  budget1.formExpenses.addEventListener("submit", (e) => {
    ...
    if (addStatus) {
      ...
      budget1.showAlert(
        "red",
        "Amount and Description is required. Amount should be a number."
      );
    }
  });
  ...
  budget1.formBudget.addEventListener("submit", (e) => {
    ...
    if (budgetStatus) {
      ...
      budget1.showAlert(
        "red",
        "Budget is required. Budget should be a number."
      );
    }
  });
